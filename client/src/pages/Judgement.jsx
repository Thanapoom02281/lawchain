                ...
                <TabContext value={value}>
                    <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                        <TabList onChange={handleChange} aria-label="ผู้ออกกฏหมายเลือกทำได้ 2 อย่าง">
                            <Tab label="เพิ่มคำตัดสิน" value="1" style={{fontSize: '20px'}} disabled={isAddingAccount || isAdding ? true : false}/>
                            <Tab label="เพิ่มบัญชีผู้พิพากษา" value="2" style={{fontSize: '20px'}} disabled={isAddingAccount || isAdding ? true : false}/>
                        </TabList>
                    </Box>
                    <TabPanel value="1">
                        <Card
                    ...
                    <TabPanel value="2">
                        ...
                        เพิ่มบัญชีผู้พิพากษา
                            ...
                            <div style={{ display: "flex", justifyContent: "center", paddingTop: "5%" }}>
                                <Button color="primary" variant="contained" style={{fontSize: '15px', color: '#ffffff'}} onClick={doAddAccount} disabled={(isAddingAccount || secret === '' || publicKey === '') ? true : false}>เพิ่มบัญชี</Button>
                            </div>
                            {isAddingAccount && <>
                                <div style={{ display: "flex", justifyContent: "center", paddingTop: "3%" }}>
                                    <Typography variant="h3" color="#021630" display="inline">
            กำลังเพิ่มบัญชีผู้พิพากษา &nbsp;
                                    </Typography>
                                    <CircularProgress color="secondary" />
                                </div>
                            </>}
